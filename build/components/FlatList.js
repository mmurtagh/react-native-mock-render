...
return{
renderScrollComponent:function(){function renderScrollComponent(props){return _react2['default'].createElement(_ScrollView2['default'],_extends({},props,{__source:{fileName:_jsxFileName,lineNumber:124}}));}return renderScrollComponent;}()};
...
var element=_react2['default'].isValidElement(ListHeaderComponent)?ListHeaderComponent:_react2['default'].createElement(ListHeaderComponent,{__source:{fileName:_jsxFileName,lineNumber:149}});
cells.push(
_react2['default'].createElement(_View2['default'],{key:'flatlist-header-key',__source:{fileName:_jsxFileName,lineNumber:151}},
_react2['default'].createElement(_View2['default'],{testID:'flatlist-header',__source:{fileName:_jsxFileName,lineNumber:152}},
element)));
...
var _element=_react2['default'].isValidElement(ListFooterComponent)?ListFooterComponent:_react2['default'].createElement(ListFooterComponent,{__source:{fileName:_jsxFileName,lineNumber:178}});
cells.push(
_react2['default'].createElement(_View2['default'],{key:'flatlist-footer-key',__source:{fileName:_jsxFileName,lineNumber:180}},
_react2['default'].createElement(_View2['default'],{testID:'flatlist-footer',__source:{fileName:_jsxFileName,lineNumber:181}},
_element)));
